...
function displayUserStatus() {
    if (isset($_SESSION["user"]) && isset($_SESSION["user"]["CKT_HOTEN"])) {
        ...
        echo '<button class="btn btn-danger dropdown-toggle" type="button" id="userDropdown" data-bs-toggle="dropdown" aria-expanded="false">';
        echo htmlspecialchars($hoTen);
        echo '</button>';
        echo '<ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">';
        echo '<li><a class="dropdown-item" href="/HTQLNT/ChuTro/capnhat_thongtin.php">Cập nhật thông tin</a></li>';
        echo '<li><a class="dropdown-item" href="/HTQLNT/ChuTro/dangxuat.php">Đăng xuất</a></li>';
        echo '</ul>';
        echo '</div>';
    } else {
        ...
        <div class="container-fluid bg-dark">
            <div class="row align-items-center py-3">
                <div class="col-12 col-md-6 d-flex justify-content-start mb-3 mb-md-0">
                    <a href="themkhutro.php" class="d-flex align-items-center text-white text-decoration-none">
