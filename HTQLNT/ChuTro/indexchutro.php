...
function displayUserStatus() {
    if (isset($_SESSION["user"]) && isset($_SESSION["user"]["CKT_HOTEN"])) {
        ...
        echo '<a href="/HTQLNT/ChuTro/dangxuat.php" class="btn btn-danger">Đăng xuất</a>';
    } else {
...
<body>
    ...
    <div class="container-fluid">
        <div class="row p-5" style="background: url('/HTQLNT/images/img5.jpeg') center/cover; height: 700px;">
