...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 28, 2025 at 03:30 AM
...
--
-- Table structure for table `chu_khu_tro`
--
...
--
-- Dumping data for table `chu_khu_tro`
--
...
('D022', 'XP036', 'Đường Đỗ Mười'),
('DU021', 'XP035', 'Đường 3 Tháng 2');

-- --------------------------------------------------------

--
-- Table structure for table `gia_thue`
--
...
--
-- Dumping data for table `gia_thue`
--
...
--
-- Dumping data for table `khoang_cach`
--

INSERT INTO `khoang_cach` (`KT_MAKT`, `TRUONG_MA`, `KC_DODAI`, `KC_DONVIDO`) VALUES
('KT001', 'TR001', 2.5, 'km'),
('KT001', 'TR006', 3.2, 'km'),
('KT001', 'TR008', 190.277, 'km'),
('KT002', 'TR001', 3, 'km'),
('KT002', 'TR007', 2.7, 'km'),
('KT002', 'TR008', 190.944, 'km'),
('KT003', 'TR002', 1.8, 'km'),
('KT003', 'TR008', 192.015, 'km'),
('KT004', 'TR002', 2.2, 'km'),
('KT004', 'TR008', 190.814, 'km'),
('KT005', 'TR003', 3.5, 'km'),
('KT005', 'TR008', 191.027, 'km'),
('KT006', 'TR003', 2.8, 'km'),
('KT006', 'TR008', 190.718, 'km'),
('KT007', 'TR004', 4, 'km'),
('KT007', 'TR008', 179.543, 'km'),
('KT008', 'TR004', 3.6, 'km'),
('KT008', 'TR008', 187.973, 'km'),
('KT009', 'TR005', 2, 'km'),
('KT009', 'TR008', 179.752, 'km'),
('KT010', 'TR005', 2.5, 'km'),
('KT010', 'TR008', 174.727, 'km'),
('KT011', 'TR001', 1.5, 'km'),
('KT011', 'TR008', 174.144, 'km'),
('KT012', 'TR002', 2, 'km'),
('KT012', 'TR008', 232.926, 'km'),
('KT013', 'TR003', 2.3, 'km'),
('KT013', 'TR008', 171.927, 'km'),
('KT014', 'TR008', 172.548, 'km'),
('KT015', 'TR008', 171.577, 'km'),
('KT016', 'TR008', 189.109, 'km');
...
('KT016', 'DU021', '0900000001', '123', 'Hoàng Thi', 105.774, 10.0324, 0);
...
('01', 'P001', '2025-01-06 14:39:45', NULL),
('01', 'P0016', '2025-03-27 00:00:00', NULL),
...
('PT004', 'P004', '456789012345', '2025-02-01 00:00:00', '2025-02-05 00:00:00', '2025-08-01 00:00:00', 0),
...
('PT008', 'P008', '890123456789', '2025-03-10 00:00:00', '2025-03-15 00:00:00', '2025-09-10 00:00:00', 0),
...
('PT011', 'P011', '112233445566', '2025-04-01 00:00:00', '2025-04-03 00:00:00', '2025-10-01 00:00:00', 0),
...
('P0016', 'LP001', 'phòng bự chà bá', 'C:/xampp/htdocs/HTQLNT/images/P0016/', 'KT001', '02', 1),
...
('P006', 'LP001', 'Phòng đơn với tiện nghi cơ bản', 'C:\\xampp\\htdocs\\HTQLNT\\images\\phong006', 'KT006', '01', 0),
('P007', 'LP002', 'Phòng đôi với nội thất đẹp', 'C:\\xampp\\htdocs\\HTQLNT\\images\\phong007', 'KT015', '04', 0),
...
--
-- Table structure for table `tinh_trang_phong`
--
...
--
-- Dumping data for table `tinh_trang_phong`
--
...
('TR001', 'D011', 'Đại học Cần Thơ', '123 Nguyễn Văn Cừ, Cần Thơ', 105.78, 10.0451, ''),
...
('TR008', 'D022', 'Đại Học Quốc Gia Thành Phố Hồ Chí Minh-Luật', 'Đường Đỗ Mười, Phường Linh Xuân, Tỉnh Bình Dương', 106.778, 10.8693, '');
...
--
-- Indexes for table `tinh_thanh_pho`
--
ALTER TABLE `tinh_thanh_pho`
  ADD PRIMARY KEY (`TTP_MATINH`);

--
-- Indexes for table `tinh_trang_phong`
--
...
--
-- Constraints for table `gia_thue`
--
ALTER TABLE `gia_thue`
...
--
-- Constraints for table `khoang_cach`
--
ALTER TABLE `khoang_cach`
...
--
-- Constraints for table `phieu_thue`
--
ALTER TABLE `phieu_thue`
